                ...
                <div className="carousel-inner">
                                ...
                                <div className="col-lg-6 mb-0 d-flex align-items-center">
                                    <div className="text-align-left align-self-center">
                                        ...
                                        <p>
                                            ...
                                            This template is 100% free provided by <a rel="sponsored" className="text-success" href="#" target="_blank">TemplateMo</a> website. 
                                            Image credits go to <a rel="sponsored" className="text-success" href="#" target="_blank">Freepik Stories</a>,
                                            <a rel="sponsored" className="text-success" href="#" target="_blank">Unsplash</a> and
                                            <a rel="sponsored" className="text-success" href="#" target="_blank">Icons 8</a>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="carousel-item">
                        <div className="container">
                            <div className="row p-5">
                                <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                                    <img className="img-fluid" src="/app/images/banner_img_02.jpg" alt="" />
                                </div>
                                <div className="col-lg-6 mb-0 d-flex align-items-center">
